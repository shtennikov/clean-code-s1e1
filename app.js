...
var incompleteTaskHolder=document.querySelector(".current-tasks__list");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='task-list__item task-item';
    ...
    editButton.className="button task-item__edit-btn";

    deleteButton.className="button task-item__delete-btn";
